...
<head>
    ...
    <title>Edit Product - Evara Admin</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* Use same styles from add-product.php */
        :root {
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li><a href="add-product.php" class="nav-item"><i class="fas fa-plus-circle"></i> <span class="nav-text">Add Product</span></a></li>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="reviews" class="form-control" 
                               min="0" value="<?php echo $product['reviews']; ?>">
                    </div>
                </div>
